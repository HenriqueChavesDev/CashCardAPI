package com.henriquechaves.cashcard.controllers.integration;

import com.henriquechaves.cashcard.controllers.CashCardController;
...
@WithMockUser(username = "henrique", roles = {"USER", "ADMIN"})
public class CashCardControllerIntegrationTests {
    ...
    void shouldBeReturnListOfCashCardsWithSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/cashcards").with(httpBasic("henrique", "1234")))
    ...
    void shouldBeReturnOnlyOneCashCardWhenReceiveID() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/cashcards/7").with(httpBasic("henrique", "1234"))
                        .with(csrf()))
                .andExpect(status().isOk())
    ...
    void shouldResponseNotFoundWhenReceiveIdCashCardNotExist() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/cashcards/222").with(httpBasic("henrique", "1234")).with(csrf()))
    ...
    void shouldDeleteCashCardByIdIsSuccess() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/cashcards/1").with(httpBasic("henrique", "1234")).with(csrf()))
    ...
    void shouldDeleteCashCardByIdIsFail() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/cashcards/178").with(httpBasic("henrique", "1234")).with(csrf()))
                .andExpect(status().isNotFound());
